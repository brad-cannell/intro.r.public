---
title: "Lab: Conditional Operations in R"
author: Brad Cannell
...
* [Click here to download the data](https://tcu.box.com/s/nalectv75gnfsoffui7gdj6s4jxxyaaw).

* [Click here to view the codebook](https://tcu.box.com/s/2urnv4y1nwrlj8z60bernll6qzpmypzo).
...
```{r}
class_survey <- read_csv('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Class Survey/Class Survey 5141.csv')
```
