...
This week, we will practice writing functions and performing column-wise repeated operations with dplyr verbs. We will do so using a couple of different data sets:
