---
title: "Lab: Introduction to Data Transfer in R"
author: Brad Cannell
...
* [chocolate study 1.xls](https://tcu.box.com/s/y93mcruntyao2p5qfhir0ef1hupj75lv)   
* [chocolate study 2.csv](https://tcu.box.com/s/1dcx6wkry67fm5cl03o9i9b31bipzhda)
* [chocolate study 3.txt](https://tcu.box.com/s/rv42prkob7p1flfkk4jdyjecgpbuovjh)
...
choco_1 <- read_excel('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Chocolate/Chocolate Study 1.xls')
```
...
```{r}
# For Dr. Cannell's computer.
choco_2 <- read_csv('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Chocolate/Chocolate Study 2.csv')
```
...
# For Dr. Cannell's computer.
choco_3 <- read_fwf(
  '/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Chocolate/Chocolate Study 3.txt',
  col_positions = fwf_widths(
    widths    = c(5, 9, 8, 4, 6, 13, 9, 9, 6, 6, 6, 6, 6, 6, 8, 7, 7, 7, 7, 9, 6),
    col_names = c(
      "uin", "last", "first", "age", "grade", "school", "parent", "marry", 
...
```{r}
alq_j <- read_xpt("https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/ALQ_J.xpt")
```
