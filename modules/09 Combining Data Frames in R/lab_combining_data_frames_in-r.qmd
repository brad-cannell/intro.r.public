---
title: "Lab: Combining Data Frames in R"
author: Brad Cannell
...
* [Click here to download city_ses.xlsx](https://tcu.box.com/s/213tdtqnnyezp62z3vmyclkqx390frd1).
...
```{r}
houston <- read_excel(
  '/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Cities SES/city_ses.xlsx',
  sheet = "Houston"
)
```
...
```{r}
# Demographics
demo_j <- read_xpt("https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/DEMO_J.xpt")
```
...
```{r}
# Medical Conditions
mcq_j <- read_xpt("https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/MCQ_J.xpt")
```
...
```{r}
# Smoking - Cigarette Use
smq_j <- read_xpt("https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/SMQ_J.xpt")
```
...
Familiarize yourself with the codebook for the data set **smq_j**, which is available on the [NHANES website](https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/SMQ_J.htm).
