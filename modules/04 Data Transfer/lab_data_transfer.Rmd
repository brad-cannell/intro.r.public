...
10. When you view the structure of `alq_j` using the `str()` function, what is the vector type shown for `alq111_f`? According to R, what kind of variable is `alq111_f`? 
