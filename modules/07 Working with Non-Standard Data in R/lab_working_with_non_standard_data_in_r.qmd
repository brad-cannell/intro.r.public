---
title: "Lab: Working with Non-Standard Data in R"
author: Brad Cannell
...
[hospital_survey.csv](https://tcu.box.com/s/un0dgxpz256579i2kbbaotlbador3brx)

[Click here to view and/or download the data dictionary](https://tcu.box.com/s/929a4m8o7l3fc61cnb1f15rz5znkakce).
...
```{r}
hospital <- read_csv('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Hospital Survey/hospital_survey.csv')
```
