...
[ntrhd_clients_may.csv](https://tcu.box.com/s/bo95bfkrcn7j4c80ms75151bbqya5i60)
...
```{r}
clients_may <- read_csv('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/NTRHD Clients/ntrhd_clients_may.csv')
```
...
```{r}
select(clients_may_dedup, 9) |> names()
```
