...
* [Click here to download dfwtemps2012.sas7bdat](https://tcu.box.com/s/1uj0a4uoiox3d3aybtt6ampgxp6v1ig0). This data set contains the average daily temperature for Dallas, TX in the year 2012.

* [Click here to download epcr_multi_treat.rds](https://tcu.box.com/s/bdkk8k5hxib4xqwmzwhstu6cgl6km24m). This data is from a local Emergency Medical Services (EMS) provider’s Electronic Patient Care Reporting (EPCR) system. Each row in the EPCR data represents a unique 911 emergency response, but not a unique person. Each person has exactly two rows.
...
```{r}
temps_2012 <- read_sas('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/Average Temperatures/dfwtemps2012.sas7bdat')
```
...
```{r}
epcr_multi_treat <- read_rds('/Users/bradcannell/Library/CloudStorage/Box-Box/Datasets/epcr/epcr_multi_treat.rds')
```
